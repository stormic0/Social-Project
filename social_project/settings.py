...
SECRET_KEY = 'xn-%3it_e4e5*7p+66a3fjl_)xfbunnouirq@zt$&mzyk=%l_8'
...
SOCIAL_AUTH_GOOGLE_OAUTH2_KEY = 'XXX'       # Google App ID
SOCIAL_AUTH_GOOGLE_OAUTH2_SECRET = 'XXX'    # Google App Secret
